# Citrix (citrix)
Citrix is a global software company providing virtualization, networking, workspace, and digital experience products that allow organizations to deliver applications and desktops securely from data centers and clouds to any device. Citrix exposes its programmable surface through Citrix Cloud and developer.citrix.com / developer-docs.citrix.com, with REST APIs spanning Virtual Apps and Desktops, DaaS, Workspace, Citrix Cloud, ADC (NetScaler) NITRO, Endpoint Management, Secure Private Access, and Analytics.

**URL:** [Visit APIs.json URL](https://raw.githubusercontent.com/api-evangelist/citrix/refs/heads/main/apis.yml)
...
## Tags:
 ...
 - Application Delivery, Desktop-As-A-Service, Networking, Virtualization, Workspace
...
#### Tags:
 ...
 - Remote Access, VDI, Virtual Desktop
...
#### Tags:
 ...
 - ADC, Application Delivery, Load Balancing, Networking
...
#### Tags:
 ...
 - Cloud, DaaS, Desktop as a Service
...
#### Tags:
 ...
 - Analytics, Insights, Monitoring, Security

### Citrix Cloud API
Platform-level API for managing Citrix Cloud services, including authentication, service principals, resource locations, and notifications.
...
OData-based API for querying monitoring data from Citrix Virtual Apps and Desktops deployments, including session, connection, machine, and application usage data.

#### Tags:

 - Analytics, Monitoring, OData, Reporting
...
#### Tags:
 ...
 - Client, Resources, Sessions, StoreFront

### Citrix StoreFront Store Services API
Server-side API for customizing and extending the Citrix StoreFront store services.

#### Tags:

 - Customization, Server, StoreFront
...
#### Tags:
 ...
 - Authentication, Identity, StoreFront

### Citrix Endpoint Management REST API
REST API for managing mobile devices, applications, and policies in Citrix Endpoint Management.

#### Tags:

 - Endpoint Management, MDM, Mobile, UEM

### Citrix Secure Private Access API
REST API for managing zero trust network access policies, applications, application domains, and certificates.

#### Tags:

 - Access Control, Security, Zero Trust, ZTNA
